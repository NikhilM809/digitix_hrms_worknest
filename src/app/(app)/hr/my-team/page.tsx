...
import { canViewTeam } from "@hrms/lib/permissions";
import type { UserStatus } from "@prisma/hrms-client";
  ...
  if (!role || !canViewTeam(role)) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <Button className="mt-6" variant="outline" onClick={() => router.push("/hr/leave")}>
          Go Back
        </Button>
      </div>
    );
