...
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@hrms/components/ui/card";
import { Button } from "@hrms/components/ui/button";
import { Badge } from "@hrms/components/ui/badge";
import { Skeleton } from "@hrms/components/ui/skeleton";
import { EmptyState } from "@hrms/components/dashboard/activity-feed";
import { fetchApi } from "@hrms/lib/api-client";
import { formatDateTime, cn } from "@hrms/lib/utils";
...
export default function NotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="font-display text-3xl tracking-tight text-ink">Notifications</h1>
