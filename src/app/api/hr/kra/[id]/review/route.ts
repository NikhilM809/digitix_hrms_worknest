...
import { kraReviewSubmitSchema } from "@hrms/lib/validations";
import { canReviewKra, isAdminOrHr } from "@hrms/lib/permissions";
import { serializeKraReviewScores, isKraLockedForManager } from "@hrms/lib/kra";
import {
  getKraItemDelegate,
...
export async function POST(
  ...
  try {
    ...
    await createNotification({
      ...
      link: `/hr/kra?tab=evaluation&id=${id}`,
    });
