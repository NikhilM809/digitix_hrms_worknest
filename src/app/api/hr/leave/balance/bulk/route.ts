...
import { isAdmin, canBulkImportLeave } from "@hrms/lib/permissions";
import { buildExcelBuffer, getRowValue, parseOptionalNumber } from "@hrms/lib/excel-utils";
import { computeLeaveBalancesForUser } from "@hrms/lib/leave-balance";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { parseExcelBuffer } = await import("@hrms/lib/excel-utils");
