...
import { formatDateInZone, formatDateTimeInZone } from "@hrms/lib/timezone-utils";
...
export function formatDate(date: Date | string, options?: Intl.DateTimeFormatOptions) {
  ...
  return formatDateInZone(date, getActiveTimeZone());
}

export function formatDateTime(date: Date | string) {
  return formatDateTimeInZone(date, getActiveTimeZone());
}
