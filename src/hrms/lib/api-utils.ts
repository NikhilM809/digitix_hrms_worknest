...
import type { RoleName, UserStatus, AuditAction } from "@prisma/hrms-client";
import { auth, hasRole } from "@hrms/lib/auth";
...
export async function createNotification(params: {
  userId: string;
  type: import("@prisma/hrms-client").NotificationType;
  title: string;
  message: string;
  link?: string;
}) {
